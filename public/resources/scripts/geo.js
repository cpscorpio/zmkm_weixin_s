...
function change(v) {
    ...
    console.log('change', v,str,ss, $('#'+s[0]));
    with (ss) {
        length = 0;
        if (dsy.Exists(str)) {
            ar = dsy.Items[str];
...
function showValue()
{
    var s1 = document.getElementById(s[0]);
    var s2 = document.getElementById(s[1]);
    var s3 = document.getElementById(s[2]);
    alert(s1.value +' > ' +  s2.value+' > '  + s3.value);
}